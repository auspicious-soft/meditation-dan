...
const Page = () => {
  ...
  return (
    <div className="grid grid-cols-12 gap-4 h-screen w-full">
      <div className="col-span-12 space-y-6 bg-[#1b2236] rounded-[12px] md:rounded-[20px] py-4 px-4 md:py-8 md:px-9">
        ...
        {/* <div className="flex flex-wrap gap-4 mt-12 justify-center sm:justify-start">
  <Button
    variant="destructive"
    className="bg-[#FF4747] min-w-[100px] w-full sm:w-48 h-11 hover:bg-[#FF4747] hover:cursor-pointer text-sm sm:text-base"
    onClick={() => setIsDialogOpen(true)}
  >
    Delete Account
  </Button>
  <Button
    variant="default"
    className="bg-[#1A3F70] min-w-[100px] w-full sm:w-28 h-11 hover:bg-[#1A3F70] hover:cursor-pointer text-sm sm:text-base"
    onClick={handleSave}
  >
    Save
  </Button>
