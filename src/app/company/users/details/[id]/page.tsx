  ...
  return (
    <div className="text-white py-6 w-full h-screen">
      ...
      <div className="flex gap-4 mt-12">
        ...
        >
          {userDetails.isAccountActive === true ? "Deactivate" : "Activate"} Account
        </Button>
      </div>
   ...
   <Dialog open={isDeactivateOpen} onOpenChange={setIsDeactivateOpen}>
    <DialogContent className="bg-[#141B2D] border-[#1F2937] w-[450px]  p-6 flex flex-col  items-center text-white rounded-lg">
     <DialogHeader className="text-center">
      <DialogTitle className="text-lg font-semibold text-center">{userDetails.isAccountActive === true ? "Deactivate" : "Activate"} Account Account</DialogTitle>
      <DialogDescription className="text-sm text-gray-400 text-center">Are you sure you want to {userDetails.isAccountActive === true ? "Deactivate" : "Activate"} your Account?</DialogDescription>
     </DialogHeader>
     <DialogFooter className="flex justify-center gap-4 mt-4">
