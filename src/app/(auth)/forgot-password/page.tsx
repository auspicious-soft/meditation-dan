    ...
    const handleSubmit = async (e: React.FormEvent<SignInFormElement>) => {
        ...
        try {
          ...
          if (response.ok && data.success) {
            ...
            // Redirect to reset-password page only on success
      ...
      <CardContent className="p-0">
       <form onSubmit={handleSubmit}>
        <div className="space-y-6">
         <Input id="email" type="Email" placeholder="Email Address" className="bg-transparent rounded-[10px] border !border-[#d9d9d9] !text-lg focus:!border-blue-500 focus:ring-0 focus-visible:ring-0 leading-[27px] h-[60px] " required />
         {/* <Link> */}
