              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      className="text-[#9a9a9a] absolute right-4 top-5 hover:cursor-pointer"
                  ...
                  <Button
                    type="submit"
                    className="cursor-pointer px-3 py-1.5 bg-[#1a3f70] h-[50px] rounded-lg text-white text-lg font w-full leading-[30px] hover:bg-[#1a3f70]"
                    disabled={isPending}
                  >
