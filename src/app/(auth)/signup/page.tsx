...
<div className="relative w-full">
  <input
    ...
    className="peer bg-transparent rounded-[10px] border !border-[#d9d9d9] text-lg focus:!border-blue-500 focus:ring-0 leading-[27px] h-[60px] w-full px-3 text-gray-900"
    required
  />
  <label
    htmlFor="birthday"
    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg pointer-events-none transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-lg peer-placeholder-shown:text-gray-400 peer-focus:top-2 peer-focus:text-sm peer-focus:text-blue-500"
  >
    Birthday
  </label>
</div>
